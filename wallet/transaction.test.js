...
describe('Transaction', () => {
    ...
    describe('update()', () => {
        let originalSignature, originalSenderOutput;
        let nextRecipient = 'next-recipient'
        let nextAmount = 0;
        describe('and the amount is invalid', () => {
            it('throws an error', () => {
                expect(() => transaction.update({ senderWallet, amount: 999999, recipient: 'foo-recipient' }))
        ...
        describe('and the amount is valid', () => {
            ...
            it('maintains the total output that matches the input amount', () => {
                expect(Object.values(transaction.outputMap).reduce((prevValue, currentValue) => prevValue + currentValue))
